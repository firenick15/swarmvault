  ...
  server.registerTool(
    "query_vault",
    {
      ...
      inputSchema: {
        ...
        asOfDate: z.string().optional().describe("Historical as-of date for authority/version questions, ISO date preferred"),
        evaluationPeriod: z.string().optional().describe("Evaluation/reporting period, for example 2023 or 2023年度"),
        evaluationYear: z.number().int().optional().describe("Evaluation/reporting year"),
