...
export const DEFAULT_ENV_AIR_PROFILE: EnvAirProfile = {
  ...
  intentRules: [
    ...
    },
    {
      ...
      priority: 126,
      anyText: ["颗粒物", "PM10", "PM2.5", "新建", "安装验收", "验收", "验收检查清单"],
      anyTermGroups: [
        ["颗粒物", "验收", "检查清单"],
        ["颗粒物", "自动监测系统", "验收"],
        ["新建", "颗粒物", "验收"],
    ...
    },
    {
      ...
      priority: 124,
      anyText: ["重污染天气", "应急预警", "应急响应", "应急减排", "绩效分级", "秋冬季攻坚", "污染过程"],
      anyTermGroups: [
        ["重污染天气", "应急"],
        ["重污染天气", "材料"],
        ["重污染天气", "绩效分级"],
    ...
    },
    {
      ...
      documentRoleBoosts: { qa_qc: 6, monitoring_method: 4, standard: 2 },
      evidenceRoleBoosts: { method: 5, current_authority: 3 },
      chunkTermBoosts: { 负值: 6, 零值: 5, 流量审核: 6, 平行性: 5, 数据有效性: 4, 环境参数: 5, 温度: 3, 气压: 3, 湿度: 3 }
    },
    {
    ...
    },
    {
      ...
      priority: 105,
      anyText: ["气态", "气态仪器", "零点漂移", "量程漂移", "零跨", "运行质控", "质控频次", "SO2", "NO2", "O3", "臭氧", "CO"],
      anyTermGroups: [
        ["气态", "零点漂移"],
        ["气态", "量程漂移"],
        ["气态", "质控"],
      ...
      documentRoleBoosts: { qa_qc: 6, monitoring_method: 4, standard: 2 },
      evidenceRoleBoosts: { method: 5, current_authority: 3 },
      chunkTermBoosts: { 零点漂移: 6, 量程漂移: 6, 零跨: 5, 质控频次: 5, 气态污染物: 4, 臭氧: 5, O3: 5, 时段: 4 }
    },
    {
