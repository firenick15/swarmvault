...
export const DEFAULT_ENV_AIR_PROFILE: EnvAirProfile = {
  ...
  standardCatalog: [
    ...
    },
    {
      ...
      aliases: ["HJ 655", "HJ655", "颗粒物连续自动监测系统", "颗粒物安装验收", "自动站安装验收", "安装和验收技术规范"],
  ...
  standardClusters: [
    ...
    },
    {
      ...
      aliases: ["自动监测安装", "新建自动站验收", "验收", "比对测试", "监测系统", "站房", "联网验收", "试运行"],
      evidenceRoles: ["current_authority", "method"],
  ...
  intentRules: [
    ...
    },
    {
      ...
      priority: 108,
      anyText: ["颗粒物", "PM10", "PM2.5", "PM 10", "PM 2.5", "流量审核", "平行性", "负值", "日常质控"],
      anyTermGroups: [
        ["颗粒物", "负值"],
        ["颗粒物", "运行质控"],
        ["颗粒物", "平行性"],
      ...
      documentRoleBoosts: { qa_qc: 6, monitoring_method: 4, standard: 2 },
      evidenceRoleBoosts: { method: 5, current_authority: 3 },
      chunkTermBoosts: { 负值: 6, 零值: 5, 流量审核: 6, 平行性: 5, 数据有效性: 4 }
    },
    {
    ...
    },
    {
      ...
      chunkTermBoosts: { 参比方法: 6, 比对: 6, 斜率: 5, 截距: 5, 相关系数: 5, 技术要求: 4 }
    },
    {
    ...
    },
    {
      ...
      priority: 105,
      anyText: ["气态", "气态仪器", "零点漂移", "量程漂移", "零跨", "运行质控", "质控频次", "SO2", "NO2", "O3", "CO"],
      anyTermGroups: [
        ["气态", "零点漂移"],
        ["气态", "量程漂移"],
        ["气态", "质控"],
      ...
      documentRoleBoosts: { qa_qc: 6, monitoring_method: 4, standard: 2 },
      evidenceRoleBoosts: { method: 5, current_authority: 3 },
      chunkTermBoosts: { 零点漂移: 6, 量程漂移: 6, 零跨: 5, 质控频次: 5, 气态污染物: 4 }
    },
    {
    ...
    },
    {
      ...
      chunkTermBoosts: { 故障: 4, 报告: 4, 恢复: 4, 停运: 4, 拆除: 4, 自动监控设施: 5, 排污单位: 5, 运行维护: 4 }
    },
    {
