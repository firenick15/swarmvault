...
export const DEFAULT_ENV_AIR_PROFILE: EnvAirProfile = {
  ...
  standardClusters: [
    ...
    },
    {
      ...
      aliases: ["运行质控", "质量保证", "质量控制", "有效数据", "负值", "零点", "量程", "转换炉效率", "转换效率", "转换器效率", "平行性"],
      evidenceRoles: ["current_authority", "method"],
      documentRoles: ["standard", "monitoring_method", "qa_qc"]
    },
    {
  ...
  intentRules: [
    ...
    },
    {
      ...
      priority: 68,
      anyText: ["污染源自动监控", "自动监控设施", "在线监控", "在线监测", "CEMS", "停运", "拆除", "故障", "采样探头"],
      anyTermGroups: [
        ["自动监控", "故障"],
        ["自动监控", "报告"],
        ["自动监控", "恢复"],
      ...
      chunkTermBoosts: { 故障: 4, 报告: 4, 恢复: 4, 停运: 4, 拆除: 4, 自动监控设施: 5 }
    },
    {
